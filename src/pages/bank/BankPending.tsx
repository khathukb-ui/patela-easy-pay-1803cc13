          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-foreground text-base">{t("done")}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-foreground text-base">{t("verifying")}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-muted-foreground text-base">{t("verified")}</p>
