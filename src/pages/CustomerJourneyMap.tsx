...
// Journey stage header - using official brand colors - Compact for PDF
function StageHeader({ icon, title, subtitle, phase }: { icon: React.ReactNode; title: string; subtitle: string; phase: "required" | "optional" | "usage" }) {
  ...
  return (
    <div className="rounded-lg p-3 mb-3" style={{ backgroundColor: style.bg, borderWidth: '2px', borderStyle: 'solid', borderColor: style.border }}>
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] px-2 py-0.5 rounded-full font-semibold" style={{ backgroundColor: style.labelBg, color: style.labelColor }}>
              {phaseLabels[phase]}
            </span>
          </div>
          <p className="text-xs" style={{ color: BRAND.textMuted }}>{subtitle}</p>
        </div>
      </div>
    </div>
  );
...
// Feature availability indicator - using brand colors - Compact
function FeatureCheck({ available, label }: { available: boolean; label: string }) {
  return (
    <div className="flex items-center gap-2 text-xs py-0.5">
      {available ? (
        <CheckCircle2 className="h-4 w-4 flex-shrink-0" style={{ color: BRAND.success }} />
      ) : (
...
export default function CustomerJourneyMap() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      // Calculate optimal scaling to fill pages without gaps
      const a4Width = 210; // mm
      const a4Height = 297; // mm
      const pxPerMm = 3.78; // approximate pixels per mm at 96 DPI
  ...
  return (
    <div className="min-h-screen" style={{ background: `linear-gradient(135deg, ${BRAND.bgDarker} 0%, ${BRAND.bgDark} 50%, ${BRAND.bgDarker} 100%)` }}>
      ...
      {/* PDF Content - Compact layout for optimal page filling */}
      <div ref={contentRef} className="max-w-5xl mx-auto" style={{ backgroundColor: BRAND.bgDarker }}>
        {/* Hero Header with Human Banner - Compact */}
        <div className="relative overflow-hidden avoid-break" style={{ background: `linear-gradient(180deg, ${BRAND.primary} 0%, ${BRAND.bgDark} 100%)` }}>
          ...
          <div className="relative px-6 py-8 text-center">
            <LogoFull className="text-5xl block mb-4" />
        ...
        <div className="px-6 py-6 avoid-break">
          <h2 className="text-xl font-bold mb-4 flex items-center gap-2" style={{ color: BRAND.text }}>
        ...
        {/* Stage 1: Required Onboarding - Compact */}
        <div className="px-6 py-6 page-break-before">
          <StageHeader
          ...
          {/* Visual Flow */}
          <div className="rounded-xl p-4" style={{ backgroundColor: BRAND.bgDark, border: `2px solid ${BRAND.primaryLight}` }}>
        ...
        {/* Stage 2: Optional Setup - Compact */}
        <div className="px-6 py-6 page-break-before">
          <StageHeader
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {/* Bank Linking */}
            <div className="rounded-xl p-4 avoid-break" style={{ backgroundColor: BRAND.warningDark, border: `2px solid ${BRAND.warning}` }}>
              <div className="flex items-center gap-3 mb-3">
                <div 
                  style={{ 
                    position: 'relative',
          ...
          {/* Skip explanation - Compact */}
          <div className="mt-4 rounded-lg p-4" style={{ backgroundColor: BRAND.warningDark, border: `2px solid ${BRAND.warning}` }}>
            <div className="flex items-start gap-3">
              <AlertCircle className="h-5 w-5 mt-0.5 flex-shrink-0" style={{ color: BRAND.warning }} />
              <div>
        ...
        <div className="px-6 py-6">
          ...
          <div className="rounded-xl p-4" style={{ backgroundColor: BRAND.success, border: `2px solid ${BRAND.successLight}` }}>
            <div className="flex flex-wrap items-center justify-center gap-2">
        ...
        {/* Feature Availability Matrix - Compact */}
        <div className="px-6 py-6 page-break-before">
          <h2 className="text-xl font-bold mb-4 flex items-center gap-2" style={{ color: BRAND.text }}>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="rounded-lg p-4 avoid-break" style={{ backgroundColor: BRAND.success, border: `2px solid ${BRAND.successLight}` }}>
            ...
            <div className="rounded-lg p-4 avoid-break" style={{ backgroundColor: BRAND.primaryDark, border: `2px solid ${BRAND.accent}` }}>
              <div className="flex items-center gap-2 mb-3">
                <div 
                  style={{ 
                    position: 'relative',
            ...
            <div className="rounded-lg p-4 avoid-break" style={{ backgroundColor: BRAND.primary, border: `2px solid ${BRAND.primaryLight}` }}>
              <div className="flex items-center gap-2 mb-3">
                <div 
                  style={{ 
                    position: 'relative',
        ...
        {/* Footer with Human Touch - Compact */}
